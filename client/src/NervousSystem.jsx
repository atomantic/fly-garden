      ...
      <section aria-label="Anatomical cell inspector"><h3 ref={inspectorHeading} tabIndex={-1} style={{overflowWrap: "anywhere"}}>{selected ? selected[0] : 'Select an anatomical cell'}</h3>
        ...
        {selected && connectionsEnabled && <>
          ...
          {adjacencyError ? <p role="alert">{adjacencyError}</p> : !adjacency ? <p role="status">Reading selected-cell adjacency…</p> : <>
            ...
            <div tabIndex={0} role="region" aria-label="Selected cell connections" style={{ overflowX: 'auto', overflowY: 'auto', maxHeight: 420, border: '1px solid #2c4033', borderRadius: 8 }}><table><thead><tr><th>Direction</th><th>Neighbor</th><th>Contacts</th><th>Engineered sign</th><th>Engineered weight</th><th>Position</th></tr></thead><tbody>{adjacency.edges.map(edge => {
